...
class FederatedClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        return loss, num_examples_test, {"accuracy of global model on local test data (client 3)": accuracy}
...
def load_data():
    """Load data of client 3 and split in train and test data."""
    ...
    train_ds = tf.keras.preprocessing.image_dataset_from_directory(
        directory='./data/client3', # complete data set can be found here: https://www.kaggle.com/christianvorhemus/industrial-quality-control-of-packages
        validation_split=0.2, # 360 * 0.8 = 288 training instances
        subset="training",
        image_size=(224, 224),
        shuffle=True,
        seed=123,
