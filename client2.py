...
class FederatedClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        return loss, num_examples_test, {"accuracy of global model on local test data (client 2)": accuracy}
...
def load_data():
    """Load data of client 2 and split in train and test data."""
    ...
    train_ds = tf.keras.preprocessing.image_dataset_from_directory(
        directory='./data/client2', # complete data set can be found here: https://www.kaggle.com/christianvorhemus/industrial-quality-control-of-packages
